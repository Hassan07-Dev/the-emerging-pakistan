                                        ...
                                        <form action="{{ route('user.update.profile') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="profile-pic-wrapper">
                                                <div class="pic-holder">
                                                  ...
                                                  <img id="profilePic" class="pic" src="{{ !auth()->user()->profile_pic ? asset ('images/single_comment.png') : asset(auth()->user()->profile_pic) }}">
            ...
            $(document).on("change", ".uploadProfileInput", function () {
                ...
                if (/^image/.test(files[0].type)) {
                    ...
                    setTimeout(() => {
                        ...
                        if (Math.random() < 0.9) {
                        $(wrapper).append(
                            '<div class="snackbar show" role="alert"><i class="fa fa-check-circle text-success"></i> Profile image selected successfully</div>'
                        );
                        ...
                        $(wrapper).append(
                            '<div class="snackbar show" role="alert"><i class="fa fa-times-circle text-danger"></i> There is an error while selecting image! Please try again later.</div>'
                        );
