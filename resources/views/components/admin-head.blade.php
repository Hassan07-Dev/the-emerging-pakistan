...
{{--    @endif--}}
    ...
    <style>
        .custom-style-count{
            ...
            border-radius: 30px;
            text-align: center;
            animation: fadeIn 3s linear 2s infinite ;
            -webkit-animation: fadeIn 3s linear 2s infinite ;
            -moz-animation: fadeIn 3s linear 2s infinite ;
            -o-animation: fadeIn 3s linear 2s infinite ;
            -ms-animation: fadeIn 3s linear 2s infinite ;
        }
        @keyframes fadeIn {
            0% { opacity: 0; }
            100% { opacity: 1; }
